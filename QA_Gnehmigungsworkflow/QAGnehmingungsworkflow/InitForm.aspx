...
--%>
    <table>
        <tr><td>Auswahl Genehmiger:<br /> <SharePoint:PeopleEditor Id="peApprover" width="350px" AllowEmpty="true" MultiSelect="false" SelectionSet="User" runat="server" allowtypein="True" ClientIDMode="Predictable"/><br /><br /></td></tr>
        <tr><td>Beschreibung:<br /><textarea id="taDescription" rows="8" cols="50" name="taDesc"></textarea> <br /><br /></td></tr>
        <tr><td>
               <input type="button" name="startWorkflowButton" value="Starten" onclick="StartWorkflow()" />
               <input type="button" name="cancelButton" value="Abbrechen" onclick="RedirFromInitForm()" />
               <br />
        </td></tr>
    </table>
    ...
    <script type="text/javascript">
        ...
        function StartWorkflow() {
            ...
            if (subscriptionId == null || subscriptionId == "") {
                ...
                var selectedPeopleValue = document.getElementsByClassName('ms-entity-resolved')[0].id;
                var initialPeopleApprover = selectedPeopleValue.substr(4, selectedPeopleValue.length);
                if (initialPeopleApprover) {
                    wfParams["peAppArg"] = initialPeopleApprover;
                }

                var taDescriptionValue = document.getElementById("taDescription").value;
                if (taDescriptionValue) {
                    wfParams['taDescArg'] = taDescriptionValue;
                }
